...
class UserAnswer(BaseModel):
    participant = models.ForeignKey(Participant, on_delete=models.CASCADE, related_name='quiz_answers')
    question = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='user_answers')
    answer = models.ForeignKey(Option, on_delete=models.CASCADE, related_name='user_answers', blank=True,
                               null=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        if question_instance:
            self.fields['answer'].queryset = Option.objects.filter(question=question_instance)
